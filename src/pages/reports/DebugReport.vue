<template>
    <div>
        <el-table :data="[summary]" size="medium" style="width: 100%" border stripe :header-cell-style="{textAlign:'center', background: '#F8F8FA'}"
        ...
        <slot v-for="item in summary.details">
            ...
            <el-table :data="item.records" style="width: 100%" border :header-cell-style="{textAlign:'center', background: '#F8F8FA'}"
                :cell-style="{textAlign:'center'}">
                ...
                <el-table-column type="expand" fixed>
                    <template slot-scope="props">
                        <el-tabs v-model="activeName">
                            ...
                            <el-tab-pane label="Content" name="content" v-if="props.row.meta_data.response.content !== null">
    ...
    export default {
        ...
        methods: {
            ...
            handleResponse(response) {
                const keys = ["response_time_ms", "encoding", "ok", "reason", "url", "text", "json", "content_size",
                    "content_type"
                ];
                keys.forEach(function(item) {
