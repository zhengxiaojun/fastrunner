            ...
            <div>
                <div style="padding-top: 10px; margin-left: 10px;">
                    ...
                    <el-dialog title="添加项目" :visible.sync="dialogVisible" width="30%" align="center">
                        <el-form :model="projectForm" :rules="rules" ref="projectForm" label-width="100px" class="project">
            ...
            <el-main style="padding: 0; margin-left: 10px">
                <el-table highlight-current-row :data="projectData.results" border stripe :show-header="projectData.results.length > 0"
                    ...
                    <el-table-column label="项目名称" width="250" align="center">
                        <template slot-scope="scope">
                            <span style="font-size: 18px; font-weight: bold; cursor: pointer;color:#19A8FF;" @click="handleCellClick(scope.row)">{{ scope.row.name }}
                                <i class="el-icon-view el-icon--right"></i></span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <!-- <el-button size="medium" @click="handleCellClick(scope.row)">详情</el-button> -->
                            <el-button size="medium" type="primary" @click="handleEdit(scope.$index, scope.row)">编辑
                            </el-button>
                            ...
                            <el-button size="medium" type="danger" @click="handleDelete(scope.$index, scope.row)">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
